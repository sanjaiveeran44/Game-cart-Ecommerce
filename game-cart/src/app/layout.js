  ...
  return (
    <ClerkProvider>
      <html lang="en" className="scroll-smooth">
        <body className={`${outfit.className} h-screen bg-gradient-to-b from-slate-50 via-white to-slate-100 text-slate-900 antialiased selection:bg-indigo-200/70 selection:text-indigo-950 overflow-x-clip`}>
